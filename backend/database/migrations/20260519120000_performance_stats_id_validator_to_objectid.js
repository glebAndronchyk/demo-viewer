...
module.exports = {
  async up(db) {
    await collMod(db, "player_accuracy", {
      $jsonSchema: {
        bsonType: "object",
        required: ["stats_id"],
        properties: {
    ...
    await collMod(db, "player_reaction", {
      $jsonSchema: {
        bsonType: "object",
        required: ["stats_id"],
        properties: {
    ...
    await collMod(db, "player_behavior", {
      $jsonSchema: {
        bsonType: "object",
        required: ["stats_id"],
        properties: {
    ...
    await collMod(db, "player_clutches", {
      $jsonSchema: {
        bsonType: "object",
        properties: {
          stats_id: { bsonType: "objectId" },
          clutch_1v1: { bsonType: "object", properties: { attempted: { bsonType: "int" }, won: { bsonType: "int" } } },
          clutch_1v2: { bsonType: "object", properties: { attempted: { bsonType: "int" }, won: { bsonType: "int" } } },
          clutch_1v3: { bsonType: "object", properties: { attempted: { bsonType: "int" }, won: { bsonType: "int" } } },
          clutch_1v4: { bsonType: "object", properties: { attempted: { bsonType: "int" }, won: { bsonType: "int" } } },
          clutch_1v5: { bsonType: "object", properties: { attempted: { bsonType: "int" }, won: { bsonType: "int" } } },
        },
      },
    });
  },
